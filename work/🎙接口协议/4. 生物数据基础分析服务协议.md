...
| 类别 | 参数 | 类型 | 取值范围 | 说明 |
| :---: | :---: | :---: | :---: | :---: |
| eeg | eegl_wave | list[float] | [-500, 500] \* 150 \* upload_cycle | 左通道脑电波形片段，初始阶段返回为空数组，之后返回数组长度为 150 \* upload_cycle |
|  | eegr_wave | list[float] | [-500, 500] \* 150 \* upload_cycle | 右通道脑电波形片段，初始阶段返回为空数组，之后返回数组长度为 150 \* upload_cycle |
