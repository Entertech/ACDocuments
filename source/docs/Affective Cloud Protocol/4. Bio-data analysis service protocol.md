...
| | eeg_alpha_power、eeg_beta_power、eeg_theta_power、eeg_delta_power、eeg_gamma_power | float | [0, 1] | EEG alpha/beta/theta/δ/gamma band energy share/decibel value, returns 0 for initial phase and poor signal quality, returns energy share/decibel value for all other cases | |
